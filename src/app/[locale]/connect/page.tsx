			...
			<section>
				<p>
					{translations.rich("telegram-and-telegram-channel", {
						...
						telegramChannelLink: (chunks) => (
							<Link target="_blank" href="https://t.me/kuzminklkk" rel="noopener noreferrer">
								{chunks}
							</Link>
						),
					})}
				...
				<p>
					{translations.rich("devto-and-farcaster", {
						devtoLink: (chunks) => (
							<Link href="https://dev.to/kuzminklk" target="_blank" rel="noopener noreferrer">
								{chunks}
							</Link>
						),
						farcasterLink: (chunks) => (
							<Link
								href="https://farcaster.xyz/kuzminklk"
								target="_blank"
								rel="noopener noreferrer"
							>
								{chunks}
